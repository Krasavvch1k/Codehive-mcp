"""
Codehive — читання spreadsheet-файлів (gsheet і xlsx) у CodeHive Agency.
...
def read_sheet(
    ...
    """
    Читає gsheet або xlsx файл у CodeHive Agency.
    ...
    meta = resolve_doc(query, kind_filter=("gsheet", "xlsx"))
